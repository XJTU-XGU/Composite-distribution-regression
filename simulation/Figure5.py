...
DEFAULT_INPUT = "results_nonlinear/friedman10_structured_transport_pgfr_results.mat"
DEFAULT_FIGURE = "outputs/Figure5.pdf"
...
def parse_args():
    parser = argparse.ArgumentParser(
        description="Plot Friedman10 structured transport and PGFR experiment results."
    )
